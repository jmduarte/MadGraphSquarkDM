...
#		  value = '((yt/cmath.sqrt(2))*costh)',
                  value = '-((complex(0,1)*yt)/cmath.sqrt(2)*costh)',
		  order = {'QED':1})

GC_110 = Coupling(name = 'GC_110',
#  		  value = '((yt/cmath.sqrt(2))*sinth)',
                  value = '-((complex(0,1)*yt)/cmath.sqrt(2)*cmath.sqrt(1-costh*costh))',
		  order = {'QED':1})
